...
fix_ASV <- read.csv(here::here("Processed_data", #read in fixed ASV-species combo
                                           ...
                                           "12s_e",
                                           "LITassignment",
                                           "problemASV_b_edited.csv")) #added missing ASVs from end of script
...
write_csv(table,
          here("Processed_data",
               ...
               "12s_e",
               "LITassignment",
               "taxonomy_groups_12s_eDNA_b.csv"))
...
write_csv(table,
          here("Processed_data",
               ...
               "12s_u",
               "LITassignment",
               "taxonomy_groups_12u_eDNA_b.csv"))
