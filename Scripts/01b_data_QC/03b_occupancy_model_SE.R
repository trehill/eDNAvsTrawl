...
#download Jags
#install.packages("R2jags") #also needed to manually select this
...
#calculate probability of occupancy for each ASV from psi, p11 and p10
 ...
 write.csv(out, "./Scripts/occupancy_modelling/royle_link/scratch/occProb_royallink_e.csv")
 saveRDS(out, "./Scripts/occupancy_modelling/royle_link/scratch/occProb_royallink_e.rds")
