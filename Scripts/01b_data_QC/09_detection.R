...
eDNA_df <-  read.csv(here::here("Processed_data",
                                "eDNA",
                                "datasets",
                                "eDNA_allsets_analysisB.csv"), #has eDNA index reads
                     head=TRUE)
...
final_data <- select(long, c('LCT', 'set_number', 'gamma_detection_method', 'alpha_detection_method',
                             'beta_detection_method', 'pabs_eDNA', 'weight_total_kg', 'pabs_trawl'))
