...
#for SE
dat_se <- read.csv("./Processed_data/eDNA/12s/12s_e/asv/matrix/data12Se_asvmatrix_metadata_nc.csv")
...
#for SU
dat_su <- read.csv("./Processed_data/eDNA/12s/12s_u/asv/matrix/data12Su_asvmatrix_metadata_nc.csv")
