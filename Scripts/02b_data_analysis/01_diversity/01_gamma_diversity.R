...
ggsave("./Outputs/analysis_b/diversity/gamma_observations#.png", 
       plot = plot,
...
ggsave("./Outputs/analysis_b/diversity/gamma_species#.png", 
       plot = plot,
       width = 6, height = 6, units = "in")
...
#plot
plot <- ggvenn(df,c("eDNA", "Trawl"), show_elements = T, label_sep = "\n", fill_color = c("#FCC442", "#5491cf","#00AFBB"), text_size = 2,
               fill_alpha=1.0) 
plot

#6 trawl, 
ggsave("./Outputs/analysis_b/diversity/gamma_venn.png", 
       plot = plot,
