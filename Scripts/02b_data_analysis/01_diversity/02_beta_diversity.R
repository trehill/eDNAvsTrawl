...
ggsave("./Outputs/analysis_b/diversity/beta_observations#.png", 
       plot = plot,
...
ggsave("./Outputs/analysis_b/diversity/beta_species#.png", 
       plot = plot,
       width = 6, height = 6, units = "in")
...
ggsave("./Outputs/analysis_b/diversity/south_venn.png", 
       plot = plot,
       width = 6, height = 6, units = "in")
...
ggsave("./Outputs/analysis_b/diversity/north_venn.png", 
       plot = plot,
       width = 6, height = 6, units = "in")
