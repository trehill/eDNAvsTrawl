...
#phyloseq installation code if above does not work; 
#source("https://raw.githubusercontent.com/joey711/phyloseq/master/inst/scripts/installer.R",
#       local = TRUE)

#microVix installation code if above does not work' 
#install.packages(
#  "microViz",
...
ggsave("./Outputs/analysis_b/pcoa/PCoA1.png", 
       plot = plot,
...
plot <- ord_plot(ordination, color = "region", shape = "method", size = 4, clip = 'on') +
  ...
  labs(title = "",
       x = "PCo1 [22.1%]",  # Change the X-axis title
       y = "PCo2 [15.1%]")  # Change the Y-axis title
...
ggsave("./Outputs/analysis_b/pcoa/PCoA_panel1.png", 
       plot = plot,
       width = 12, height = 7, units = "in")
