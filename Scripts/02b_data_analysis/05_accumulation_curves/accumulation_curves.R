...
ggsave("./Outputs/analysis_b/accumcurves/curve_all.png", 
       plot = plot,
...
ggsave("./Outputs/analysis_b/accumcurves/curve_trawl.png", 
       plot = plot,
       width = 12, height = 7, units = "in")
...
ggsave("./Outputs/analysis_b/accumcurves/curve_eDNA.png", 
       plot = plot,
       width = 12, height = 7, units = "in")
...
ggsave("./Outputs/analysis_b/accumcurves/curve_all_final.png", 
       plot = plot,
       width = 12, height = 7, units = "in")
